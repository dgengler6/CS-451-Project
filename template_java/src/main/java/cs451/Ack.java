...
public class Ack extends Message {
    ...
    public Ack( Message message){
        super( message.getSeqNbr(), message.getOrder(),  message.getDestId(),  message.getDestIp(), message.getDestPort(),  message.getSenderId(),  message.getSenderIp(),  message.getSenderPort(), message.getForwardId(), message.getForwardIp(), message.getForwardPort(),  "");
